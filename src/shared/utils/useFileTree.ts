import { ref, computed, ComputedRef, markRaw } from 'vue'
...
const getFileIcon = (
  ...
  if (item.type === 'folder') {
    return {
      type: 'component',
      value: markRaw(item.isExpanded ? FolderOpenIcon : FolderIcon),
    }
  }
  ...
  switch (extension) {
    case 'vue':
      return { type: 'component', value: markRaw(VueIcon) }
    case 'ts':
      return { type: 'component', value: markRaw(TypescriptIcon) }
    case 'js':
      return { type: 'component', value: markRaw(DocumentIcon) }
    case 'css':
      return { type: 'component', value: markRaw(TailwindIcon) }
    case 'scss':
      return { type: 'component', value: markRaw(TailwindIcon) }
    case 'json':
      return { type: 'component', value: markRaw(CubeIcon) }
    case 'md':
      return { type: 'component', value: markRaw(BookOpenIcon) }
    case 'svg':
      return { type: 'component', value: markRaw(PhotoIcon) }
    case 'ico':
      return { type: 'component', value: markRaw(PhotoIcon) }
    default:
      return { type: 'component', value: markRaw(DocumentIcon) }
